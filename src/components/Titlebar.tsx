...
export default function Titlebar() {
    ...
    return (
        ...
        text-text
        *:bg-surface *:transition-colors *:select-none *:hover:text-primary
        *:w-[24px] *:h-[24px] *:inline-flex *:justify-center *:items-center
        ">
            <button class="titlebar-button" onclick={appWindow.minimize}>
            ...
            <button class="titlebar-button" onclick={appWindow.maximize}>
            ...
            <button class="titlebar-button" onclick={appWindow.close}>
